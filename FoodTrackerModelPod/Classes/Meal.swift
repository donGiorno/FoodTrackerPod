...
public class Meal: NSObject, NSCoding {
    ...
    public init?(name: String, photo: UIImage?, rating: Double) {
    ...
    required convenience public init?(coder aDecoder: NSCoder) {
        ...
        self.init(name: name, photo: photo, rating: Double(rating))

    }
    
    static public func saveMeals(meals: [Meal]) {
    ...
    static public func loadMeals() -> [Meal]? {
